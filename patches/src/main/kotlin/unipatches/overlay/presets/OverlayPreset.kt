...
internal data class OverlayUiPreset(
    ...
    val buttonSize: Int,
    val menuWidthLimit: Int = 90,
    val menuHeightLimit: Int = 45,
    val showExtraPopupHeaders: Boolean = true,
    ...
    val iconTextFont: String = "default",
    val menuTextFont: String = "default",
    ...
    val menuTextColor7: String = outline,
...
internal fun explicitOverlayPreset(
    ...
    menuWidthLimit: Int = 90,
    menuHeightLimit: Int = 45,
    showExtraPopupHeaders: Boolean = true,
    ...
    iconTextFont: String = "default",
    menuTextFont: String = "default",
    ...
    buttonSize = 56,
    menuWidthLimit = menuWidthLimit.coerceIn(45, 90),
    menuHeightLimit = menuHeightLimit.coerceIn(45, 90),
    showExtraPopupHeaders = showExtraPopupHeaders,
    buttonOpacity = 50,
    dragVisibilityDuration = 2,
    buttonPosition = "topRight",
    activityOverride = "",
    iconTextSize = 18,
    iconTextFont = iconTextFont,
