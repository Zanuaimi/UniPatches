...
val pairipBypassPatch = bytecodePatch(
    ...
    description = """
        ...
        It combines resilient method targeting from Nai64, broader method coverage from Entree,
        repeated-check detection from kondratjev, and optional VM call-site handling inspired by Doom.

        This does not bypass server-side Play Integrity or other server-side enforcement.
