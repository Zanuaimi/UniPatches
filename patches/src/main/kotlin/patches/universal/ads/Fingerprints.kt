...
internal object PairipLicenseActivityCloseMethodFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "closeApp",
    returnType = "V",
    parameters = emptyList(),
...
internal object PairipLicenseActivityExitMethodFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "exitApp",
    returnType = "V",
    parameters = emptyList(),
...
internal object PairipCloseappFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "closeapp",
    returnType = "V",
    parameters = emptyList(),
...
internal object PairipExitappFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "exitapp",
    returnType = "V",
    parameters = emptyList(),
...
// Entree covers additional method names used by older and lightly obfuscated
// PairIP builds. Keep these exact and return-type constrained: inserting a
// return-void into a non-void method would produce invalid bytecode.
internal object PairipLicenseClientConnectToLicensingServiceFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseClient;",
    name = "connectToLicensingService",
    returnType = "V",
)

internal object PairipLicenseClientProcessResponseFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseClient;",
    name = "processResponse",
    returnType = "V",
)

internal object PairipLicenseActivityCloseAllTasksFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "closeAllTasks",
    returnType = "V",
)

internal object PairipLicenseActivityShowErrorDialogFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "showErrorDialog",
    returnType = "V",
)

internal object PairipLicenseActivityLogAndShowErrorDialogFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseActivity;",
    name = "logAndShowErrorDialog",
    returnType = "V",
)

// kondratjev's implementation is resilient to PairIP moving the repeated
// check read into a differently named method. Restrict the field filter to
// LicenseClient so unrelated application booleans are never changed.
internal object PairipRepeatedCheckEnabledReadFingerprint : Fingerprint(
    definingClass = "Lcom/pairip/licensecheck/LicenseClient;",
    filters = listOf(
        fieldAccess(
