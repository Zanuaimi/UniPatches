...
Then open `http://127.0.0.1:4173` on the device.
4. Build or import the icon, use **Download .txt** or **Copy rows**, and paste the result into the
...
> **[v1.16.0](https://github.com/Zanuaimi/UniPatches/releases/tag/v1.16.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;9 patches total
<details open>
