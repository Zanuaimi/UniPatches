...
public final class AdsControlRuntimeProvider implements OverlayAppSpecificModuleProvider {
    ...
    private static final class HostsModule extends OverlayAppSpecificModule {
        ...
        @Override public String description() { return "Enable or disable policy-aware host blocking for literal endpoints instrumented by Control App Ads. The initial state follows the Ads patch's Enable Block Ads / Tracking Hosts setting. Credits to Adobo and Entree for the original tracking-hosts approach."; }
